...
void initPwm()
{
    ...
    GPIO_PORTF_DEN_R |= MOTOR1_MASK | MOTOR2_MASK;
    GPIO_PORTF_AFSEL_R |= MOTOR1_MASK | MOTOR2_MASK;
    GPIO_PORTF_PCTL_R &= ~(GPIO_PCTL_PF1_M | GPIO_PCTL_PF3_M);
    GPIO_PORTF_PCTL_R |= GPIO_PCTL_PF1_M1PWM5 | GPIO_PCTL_PF3_M1PWM7;
    ...
    PWM1_2_CMPB_R = 0;
    PWM1_3_CMPB_R = 0;                               // red off (0=always low, 1023=always high)
...
void initPwm()
{
    ...
    GPIO_PORTF_DEN_R |= MOTOR1_MASK | MOTOR2_MASK;
    GPIO_PORTF_AFSEL_R |= MOTOR1_MASK | MOTOR2_MASK;
    GPIO_PORTF_PCTL_R &= ~(GPIO_PCTL_PF1_M | GPIO_PCTL_PF2_M);
